...
import static dhomo.crmmail.api.imap.ImapService.DEFAULT_INITIAL_MESSAGES_BATCH_SIZE;
import static dhomo.crmmail.api.imap.ImapService.DEFAULT_MAX_MESSAGES_BATCH_SIZE;
import static dhomo.crmmail.api.imap.ImapService.IMAP_CAPABILITY_CONDSTORE;
        ...
        try {
            do {
                ...
                final ServerSentEvent<List<Message>> event = ServerSentEvent
                        .builder(imapService.getMessagesEnvelope(folder, start, end, fetchModseq))
